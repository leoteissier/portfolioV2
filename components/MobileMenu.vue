<template>
  <div id="mobile-menu" class="w-full z-10 lg:hidden">
    ...
    <div id="mobile-header" class="w-full h-16 flex justify-between items-center">
      ...
      <img src="/svg/burger.svg" v-if="!menuOpen" @click="toggleMobileMenu()" class="w-5 h-5 mx-5 my-auto"/>
      <img src="/svg/burger-close.svg" v-else @click="toggleMobileMenu()" name="icon-park-outline:close" class="w-5 h-5 mx-5 my-auto"/>
    </div>
